...
class TrainOptions(BaseOptions):
	def initialize(self, parser):
		...
		parser.add_argument('--which_epoch', type=str, default='0', help='which epoch to load? set to latest to use latest cached model')
		...
		parser.add_argument('--lr_task', type=float, default=5e-5, help='initial learning rate for adam')
		...
		parser.add_argument('--show_freq', type=int, default=1, help='frequency of showing training results on plot')
