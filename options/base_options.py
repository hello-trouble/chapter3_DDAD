...
class BaseOptions():
	...
	def initialize(self, parser):
		parser.add_argument('--model', type=str, default='dehazereconda2stagesED', help='chooses which model to use.')
		parser.add_argument('--dataroot', default="/home/qiaoyingxv/datasets/domain_dehazing",help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
		parser.add_argument('--name', type=str, default='coor_featglobal129',help='name of the experiment. It decides where to store samples and models')
		...
		parser.add_argument('--image_feature', type=int, default=256, help='the max channels for image features')
		...
		parser.add_argument('--init_type', type=str, default='xavier', help='network initialization [normal|xavier|kaiming]')
	...
	def parse(self):
		...
		if len(opt.gpu_ids) > 0:
			torch.cuda.set_device(opt.gpu_ids[0]) #opt.gpu_ids[0]
