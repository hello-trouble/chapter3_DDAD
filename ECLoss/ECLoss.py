    ...
    def forward(self, org, enhance):
        ...
        weight_diff = torch.max(
            torch.FloatTensor([1]).cuda() + 10000 * torch.min(org_pool - torch.FloatTensor([0.3]).cuda(),
                                                              torch.FloatTensor([0]).cuda()),torch.FloatTensor([0.5]).cuda())
...
if __name__ == "__main__":
    img = Image.open('/home/qiaoyingxu/datasets/domain_dehazing/real_haze/YT_Google_738.jpeg')
