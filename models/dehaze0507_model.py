...
class Dehaze0507Model(BaseModel):
    def name(self):
        return 'dehaze0507model'
...
####### changed as below:
            if self.opt.epoch_count <= 80:
                self.opt.lr = self.opt.lr
            elif self.opt.epoch_count > 80 and self.opt.epoch_count < 160:
                self.opt.lr = 0.000075
            elif self.opt.epoch_count >= 160:
                self.opt.lr = 0.00005
