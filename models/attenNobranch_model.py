...
#### changed the up_learning_rate, replace the self.opt.epoch_count with the epoch
import os
# import numpy as np
import torch
...
from networks_msbdn.MSBDN_DFF_attention_nobranch import Net as Net_domain_concat
...
class attenNobranchModel(BaseModel):
    def name(self):
        return 'attenNobranchmodel'
