...
#from networks_msbdn.MSBDN_DFF_norealBranch import Net as Net_domain_concat
...
class norealBranchModel(BaseModel):
    def name(self):
        return 'norealBranchmodel'
...
####### changed as below:
    ...
    def forward(self):
        ...
        _,_,_,self.real_dehazing_img= self.netR_Dehazing(self.real_haze_img, data_type='real_syn')
    ...
    def forward3(self):
        ...
        _, _, self.real_features, self.real_dehazing_img = self.netR_Dehazing(self.real_haze_img, data_type='real_syn')
        self.rs_recon_img = self.netR_recon(self.real_syn_dehazing_img)
