...
class Net(nn.Module):
    def __init__(self, res_blocks=18):
        ...
        self.dehaze_2 =  ResidualDAttentionBlock(256, reduction=16)
        self.dehaze_3 =  ResidualBlock(256)
        self.dehaze_4 =  ResidualDAttentionBlock(256, reduction=16)
        self.dehaze_5 =  ResidualBlock(256)
        self.dehaze_6 =  ResidualDAttentionBlock(256, reduction=16)
        self.dehaze_7 =  ResidualBlock(256)
        self.dehaze_8 =  ResidualDAttentionBlock(256, reduction=16)
        self.dehaze_9 =  ResidualBlock(256)
        self.dehaze_10 = ResidualDAttentionBlock(256, reduction=16)
        self.dehaze_11 = ResidualBlock(256)
        self.dehaze_12 = ResidualDAttentionBlock(256, reduction=16)
        self.dehaze_13 = ResidualBlock(256)
        self.dehaze_14 = ResidualDAttentionBlock(256, reduction=16)
        self.dehaze_15 = ResidualBlock(256)
        self.dehaze_16 = ResidualDAttentionBlock(256, reduction=16)
    ...
    def forward(self, x,data_type):
        ...
        res16x = self.dehaze_2(res16x, data_type)
        res16x = self.dehaze_3(res16x)
        res16x = self.dehaze_4(res16x, data_type)
        res16x = self.dehaze_5(res16x)
        res16x = self.dehaze_6(res16x, data_type)
        res16x = self.dehaze_7(res16x)
        res16x = self.dehaze_8(res16x, data_type)
        res16x = self.dehaze_9(res16x)
        res16x = self.dehaze_10(res16x, data_type)
        res16x = self.dehaze_11(res16x)
        res16x = self.dehaze_12(res16x, data_type)
        res16x = self.dehaze_13(res16x)
        res16x = self.dehaze_14(res16x, data_type)
        res16x = self.dehaze_15(res16x)
        res16x = self.dehaze_16(res16x, data_type)
