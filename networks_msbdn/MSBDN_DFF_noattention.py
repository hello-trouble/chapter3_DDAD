...
class ResidualDAttentionBlock(torch.nn.Module):
    ...
    def forward(self,z,data_type):
        ...
        y= self.conv2(y)
        atten = self.db_atten.forward_datatype(y)
        out=residual + atten
        return out
...
class Net(nn.Module):
    def __init__(self, res_blocks=18):
        ...
        self.dehaze_6 =   ResidualBlock(256)
        ...
        self.dehaze_12 = ResidualBlock(256)
        ...
        self.dehaze_18 = ResidualBlock(256)
    ...
    def forward(self, x,data_type):
        ...
        res16x = self.dehaze_18(res16x)+ in_ft - res_dehaze
